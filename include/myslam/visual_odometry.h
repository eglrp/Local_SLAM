...
public:
    ...
    vector< DMatch > cur_good_matches_;	//当前帧与上一关键帧之间的匹配
...
protected:  
    ...
    bool checkKeyFrame();
    void reconstruct(Mat &K, Matrix3d &R1, Matrix3d &R2, Vector3d &t1, Vector3d &t2, vector<Point2f> &p1, vector<Point2f> &p2, Mat &structure);		//三角化空间点
